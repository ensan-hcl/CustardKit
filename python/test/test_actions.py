...
class TestActions(unittest.TestCase):
    ...
    def test_LongoressAction(self):
        ...
        smart_move_cursor = action_smart_move_cursor(ScanDirection.backward, targets=["0"])
        dismiss_keyboard = action_dismiss_keyboard
        action = LongpressAction(start=[input, delete], repeat=[smart_move_cursor,dismiss_keyboard])
